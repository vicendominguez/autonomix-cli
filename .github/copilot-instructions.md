# Copilot Instructions for Autonomix CLI v2

## Project Overview

Autonomix CLI v2 is a Go-based application manager that installs and tracks applications from GitHub releases. It supports multiple installation methods: system packages (.deb, .rpm, .flatpak, .snap, .appimage, Arch packages), Homebrew (macOS), and direct binary installation. Provides both CLI and TUI interfaces.
